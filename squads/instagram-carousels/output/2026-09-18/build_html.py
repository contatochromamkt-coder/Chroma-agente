...
<style>
  ...
  * {{ margin:0; padding:0; box-sizing:border-box; }}
  ...
  .object-wrap img {{
    ...
    object-fit:contain;
    mask-image: radial-gradient(circle at center, black 42%, transparent 70%);
    -webkit-mask-image: radial-gradient(circle at center, black 42%, transparent 70%);
...
<body>
  ...
  <div class="frame">
    ...
    <div class="intro">O primeiro índice de maturidade em IA do varejo brasileiro acaba de nascer</div>
    <div class="headline">
      <div class="row line1">
        <span class="word-shadow">USAR IA</span>
        <span class="word-main">USAR IA</span>
      </div>
      <div class="row line2">
        <span class="word-shadow">NÃO É ESTRATÉGIA</span>
        <span class="word-main">NÃO É ESTRATÉGIA</span>
      </div>
    </div>
    <div class="object-wrap">
      <img src="data:image/jpeg;base64,{obj_b64}">
    </div>
    <div class="support">ChatGPT é só a camada mais rasa. <strong>As outras 5 dimensões é que decidem sua maturidade real.</strong></div>
