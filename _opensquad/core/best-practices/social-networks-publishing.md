...
- **Image hosting**: Use Cloudinary for public URLs (requires `CLOUDINARY_CLOUD_NAME` and an unsigned `CLOUDINARY_UPLOAD_PRESET` in `.env`). Free account at https://cloudinary.com/. imgBB is not recommended — Meta's Graph API media fetcher has been unreliable retrieving images hosted there.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Image upload: 7/7 images uploaded to Cloudinary
